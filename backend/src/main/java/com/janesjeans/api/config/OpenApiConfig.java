    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                ...
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .description("REST API for Jane's Jeans e-commerce platform. Includes public shop endpoints, authenticated admin endpoints, and user management.")
                        .contact(new Contact().name("Jane's Jeans Dev Team").email("dev@janesjeans.com"))
